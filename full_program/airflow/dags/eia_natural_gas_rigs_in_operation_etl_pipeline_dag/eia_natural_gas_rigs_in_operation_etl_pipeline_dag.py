...
with DAG(dag_id='natural_gas_rigs_in_operation_etl_pipeline', default_args=default_args, schedule_interval = timedelta(days=7, hours=2), 
    ...
    natural_gas_rigs_in_operation_extraction_task = PythonOperator(
    ...
    natural_gas_rigs_in_operation_extraction_task >> drop_columns_task >> drop_nulls_task >> convert_values_to_int_task \
