...
def data_quality_checks():
    ...
    # Previous natural gas rigs in operation date
    ...
    if natural_gas_rigs_in_operation_json_previous:
        ...
        start_date = natural_gas_rigs_in_operation_df_previous['date'].iloc[0] 
    else:
        start_date = natural_gas_rigs_in_operation_df_current['date'].iloc[0]

    end_date = natural_gas_rigs_in_operation_df_current['date'].iloc[-1]
    ...
    # Validate schema
    schema.validate(natural_gas_rigs_in_operation_df_current)