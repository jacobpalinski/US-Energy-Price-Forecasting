...
def drop_nulls():
    ...
    logger.info(f"Number of records before dropping nulls: {len(natural_gas_monthly_variables_df)}")

    # Drop null values from natural_gas_monthly_variables_df
    ...
    logger.info(f"Number of records after dropping nulls: {len(natural_gas_monthly_variables_df)}")
