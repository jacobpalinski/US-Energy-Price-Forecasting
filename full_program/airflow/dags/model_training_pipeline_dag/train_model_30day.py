...
def train_model_30day():
    ...
    train_dataset_30day = EtlTransforms.build_dataset(x=X_train, y=y_train, sequence_length=14, batch_size=128)
    validation_dataset_30day = EtlTransforms.build_dataset(x=X_test, y=y_test, sequence_length=14, batch_size=128)
    print('sequences successfully created')

    # Train GRU model
    Model.train_model(train_dataset_30day, validation_dataset_30day, time_steps=14, experiment_id=experiment_id, forecast_horizon=30)
