...
def extend_previous_data():
    ...
    # Retrieve latest transformed data from S3 and convert to dataframe with date as index
    ...
    logger.info(f"Final dataset after concatenation contains {len(heating_oil_spot_prices_df)} rows")
